...
{
  if (
# 1469 "/usr/local/cuda-8.0/targets/x86_64-linux/include/device_functions.hpp"
     0 
# 1469 "/usr/local/cuda-8.0/targets/x86_64-linux/include/device_functions.hpp" 3
                       && !
# 1469 "/usr/local/cuda-8.0/targets/x86_64-linux/include/device_functions.hpp"
                           1
# 1469 "/usr/local/cuda-8.0/targets/x86_64-linux/include/device_functions.hpp" 3
...
{
  if (
# 1236 "/usr/local/cuda-8.0/targets/x86_64-linux/include/math_functions.hpp"
     0
# 1236 "/usr/local/cuda-8.0/targets/x86_64-linux/include/math_functions.hpp" 3
                      ) {
    return __nv_fast_sinf(a);
  } else {
    return __nv_sinf(a);
...
{
  if (
# 1245 "/usr/local/cuda-8.0/targets/x86_64-linux/include/math_functions.hpp"
     0
# 1245 "/usr/local/cuda-8.0/targets/x86_64-linux/include/math_functions.hpp" 3
                      ) {
    return __nv_fast_cosf(a);
  } else {
    return __nv_cosf(a);
...
{
  if (
# 1254 "/usr/local/cuda-8.0/targets/x86_64-linux/include/math_functions.hpp"
     0
# 1254 "/usr/local/cuda-8.0/targets/x86_64-linux/include/math_functions.hpp" 3
                      ) {
    __nv_fast_sincosf(a, sptr, cptr);
  } else {
...
{
  if (
# 1278 "/usr/local/cuda-8.0/targets/x86_64-linux/include/math_functions.hpp"
     0
# 1278 "/usr/local/cuda-8.0/targets/x86_64-linux/include/math_functions.hpp" 3
                      ) {
    return __nv_fast_tanf(a);
  } else {
    return __nv_tanf(a);
...
{
  if (
# 1287 "/usr/local/cuda-8.0/targets/x86_64-linux/include/math_functions.hpp"
     0
# 1287 "/usr/local/cuda-8.0/targets/x86_64-linux/include/math_functions.hpp" 3
                      ) {
    return __nv_fast_log2f(a);
  } else {
    return __nv_log2f(a);
...
{
  if (
# 1296 "/usr/local/cuda-8.0/targets/x86_64-linux/include/math_functions.hpp"
     0
# 1296 "/usr/local/cuda-8.0/targets/x86_64-linux/include/math_functions.hpp" 3
                      ) {
    return __nv_fast_expf(a);
  } else {
    return __nv_expf(a);
...
{
  if (
# 1305 "/usr/local/cuda-8.0/targets/x86_64-linux/include/math_functions.hpp"
     0
# 1305 "/usr/local/cuda-8.0/targets/x86_64-linux/include/math_functions.hpp" 3
                      ) {
    return __nv_fast_exp10f(a);
  } else {
...
{
  if (
# 1349 "/usr/local/cuda-8.0/targets/x86_64-linux/include/math_functions.hpp"
     0
# 1349 "/usr/local/cuda-8.0/targets/x86_64-linux/include/math_functions.hpp" 3
                      ) {
    return __nv_fast_logf(a);
  } else {
    return __nv_logf(a);
...
{
  if (
# 1358 "/usr/local/cuda-8.0/targets/x86_64-linux/include/math_functions.hpp"
     0
# 1358 "/usr/local/cuda-8.0/targets/x86_64-linux/include/math_functions.hpp" 3
                      ) {
    return __nv_fast_log10f(a);
  } else {
...
{
  if (
# 1585 "/usr/local/cuda-8.0/targets/x86_64-linux/include/math_functions.hpp"
     0
# 1585 "/usr/local/cuda-8.0/targets/x86_64-linux/include/math_functions.hpp" 3
                      ) {
    return __nv_fast_powf(a, b);
  } else {
